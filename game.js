...
(function () {
  ...
  class Game {
    constructor(canvas) {
      ...
      this._bgmCfg = { vol: 0.9, type: 'triangle', step: 0.34, scale: [174.61,196,220,261.63,293.66,349.23,392,440], bass: [174.61,130.81], bassEvery: 8, btnBg: 'rgba(44,60,28,0.5)', btnFg: '#f4f8e8' }
