...
(function () {
  ...
  class Game {
    constructor(canvas) {
      ...
      this._bgmCfg = { vol: 0.9, type: 'triangle', step: 0.34, scale: [349.22,392,440,523.26,587.32,698.46,784,880], bass: [174.61,130.81], bassEvery: 8, btnBg: 'rgba(44,60,28,0.5)', btnFg: '#f4f8e8' }
    ...
    _bgmSeed(lv) {
      ...
      let x = 2166136261; const s = 'hfpc-josephgrain-match3|' + (lv || 1)
